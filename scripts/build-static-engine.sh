...
sed "s#$(pwd)/buildroot#$DORY_STATIC_PHP_PREFIX#g" "buildroot/bin/php-config" > "$DORY_STATIC_PHP_PREFIX/bin/php-config"
...

{
    ...
    echo "libs=$("$DORY_STATIC_PHP_PREFIX/bin/php-config" --libs)"
